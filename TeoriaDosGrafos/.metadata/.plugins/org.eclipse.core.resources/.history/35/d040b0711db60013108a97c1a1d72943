...
public class BuscaEmProfundidadeTeste {
	...
	private AlgoritmosDeBusca buscaEmProfundidade;
	@Before
	public void setup()
	{
		buscaEmProfundidade = new AlgoritmosDeBusca();
	}
	
	@Test
	public void realizarBuscaProfundidade(){
		//DFS
		...
		VetorRoteamento retorno = buscaEmProfundidade.buscarEmProfundidade(grafo);
